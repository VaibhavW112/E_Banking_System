...
import com.app.serviceImpl.AdminDetails;
import com.app.serviceImpl.CustomerDetails;
...
public class JwtUtils {
	...
	public String generateJwtTokenforCustomer(Authentication authentication) {
...
//JWT : userName,issued at ,exp date,digital signature(does not typically contain password , can contain authorities
	...
	public String generateJwtTokenforAdmin(Authentication authentication) {
		log.info("generate jwt token " + authentication);
